...
const SYNONYM_GROUPS: { match: string[]; canonical: string }[] = [
  ...
  { match: ["egg yolk", "egg yolks", "yolks"], canonical: "eggs" },
  { match: ["large eggs", "whole eggs", "whole egg"], canonical: "eggs" },
  { match: ["egg", "eggs"], canonical: "eggs" },
  { match: ["vanilla extract", "pure vanilla extract", "vanilla bean"], canonical: "vanilla" },
  { match: ["vanilla"], canonical: "vanilla" },
  { match: ["marsala wine", "sweet marsala"], canonical: "marsala" },
  { match: ["coffee liqueur", "kahlua", "kahlúa"], canonical: "coffee liqueur" },
